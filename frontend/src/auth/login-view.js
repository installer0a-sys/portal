      ...
      <div class="mx-auto grid min-h-[calc(100vh-2.5rem)] max-w-7xl items-center gap-10 lg:grid-cols-[1.25fr_0.75fr]">
        <section class="hidden lg:block">
          <div class="text-white">
            <h1 class="text-5xl font-bold leading-tight">Portal Web<br><span class="font-light">Azko Kudus Sudirman</span></h1>
          </div>
        </section>

        <section class="flex min-h-[410px] w-full flex-col justify-center rounded-[24px] border border-white/10 bg-slate-800/90 p-7 shadow-2xl backdrop-blur sm:min-h-[440px] sm:p-10">
          <div class="lg:hidden">
            <h1 class="text-3xl font-bold text-white">Portal Web<br><span class="font-light">Azko Kudus Sudirman</span></h1>
          </div>
          ...
          <form id="portal-login-form" data-login-form class="mt-7 space-y-4" autocomplete="on">
            <input id="portal-login-username" name="username" data-login-username type="text" autocomplete="username" autocapitalize="none" spellcheck="false" required class="min-h-12 w-full rounded-lg border border-slate-500 bg-slate-600 px-4 text-white placeholder:text-slate-200 outline-none transition focus:border-brand-500 focus:ring-4 focus:ring-brand-500/15" placeholder="Username / NIP">
            <input id="portal-login-password" name="password" data-login-password type="password" autocomplete="current-password" required class="min-h-12 w-full rounded-lg border border-slate-500 bg-slate-600 px-4 text-white placeholder:text-slate-200 outline-none transition focus:border-brand-500 focus:ring-4 focus:ring-brand-500/15" placeholder="Kata Sandi Anda">
